...
| <a name="input_secrets"></a> [secrets](#input\_secrets) | (optional) secrets to be passed to the container. By default none is passed | <pre>set(object({<br>    name  = string<br>    value = string<br>  }))</pre> | `[]` | no |
